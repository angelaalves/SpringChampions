 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://www.tibco.com/schemas/TheChampionsAcademyLeague/Service/Closet/Schema.xsd}ClosetOut" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "ClosetDataOutput", namespace = "http://www.tibco.com/schemas/TheChampionsAcademyLeague/Service/Closet/Schema.xsd")
public class ClosetDataOutput {
    ...
    public ClosetDataOutput(List<ClosetOut> closetOut) {
        this.closetOut = closetOut;
    }
     ...
     * This is why there is not a <CODE>set</CODE> method for the closetOut property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getClosetOut().add(newItem);
     * </pre>
     * 
     * 
     * <p>
