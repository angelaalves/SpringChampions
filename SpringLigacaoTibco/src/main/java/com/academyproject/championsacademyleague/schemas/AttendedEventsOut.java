...
@XmlType(name = "")
@XmlRootElement(name = "attendedEventsOut", namespace = "http://www.tibco.com/schemas/TheChampionsAcademyLeague/Service/AttendedEvents/Schema.xsd")
public class AttendedEventsOut {
