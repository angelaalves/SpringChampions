...
@XmlType(name = "")
@XmlRootElement(name = "NotificationsIn")
public class NotificationsIn {
    ...
    public NotificationsIn(String idEventFK, String idGuildFK, String idNotification, String idPlayerSenderFK, String idRewardFK){
