...
@XmlType(name = "")
@XmlRootElement(name = "NotificationReceiversOut", namespace = "http://www.tibco.com/schemas/TheChampionsAcademyLeague/Service/NotificationReceivers/Schema.xsd")
public class NotificationReceiversOut {
    ...
    public NotificationReceiversOut(){}

    public NotificationReceiversOut(String idGuildFK,String idNotificationFK, String idNotificationReceiver, String idPlayerReceiverFK,String notificationSeen ){
