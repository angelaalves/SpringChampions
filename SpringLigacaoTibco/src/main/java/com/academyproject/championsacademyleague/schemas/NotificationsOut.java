...
public class NotificationsOut {
    ...
    public NotificationsOut(){}

    public NotificationsOut(String idEventFK, String idGuildFK, String idNotification, String idPlayerSenderFK, String idRewardFK, String description){
