...
@XmlType(name = "")
@XmlRootElement(name = "NotificationsOut")
public class NotificationsOut {
    ...
    public NotificationsOut(String idEventFK, String idGuildFK, String idNotification, String idPlayerSenderFK, String idRewardFK){
